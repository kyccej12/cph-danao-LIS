...
<div id="main">
    ...
    <table width=90% cellpadding=0 cellspacing=0 align=center>
        ...
        <tr>
            <td width=15%>Unit Serial No.</td>
            <td>:</td>
            <td width=25% style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_unitserial'].'</td>
            <td width=15%>&nbsp;</td>
            <td width=15%>Date Collected</td>
            <td>:</td>
            <td width=25% style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_datecollected'].'</td>
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=15%>Segment No.</td>
            <td>:</td>
            <td width=25% style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_segment'].'</td>
            <td width=15%>&nbsp;</td>
            <td width=15%>Date Expiry</td>
            <td>:</td>
            <td width=25% style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_dateexpiry'].'</td>
        </tr>
        <tr><td height=2></td></tr>
        <tr>
            <td width=15%>Unit Blood Type</td>
            <td>:</td>
            <td width=25% style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_bloodtype'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$b['cmr_bloodtype_group'].'</td>
            <td width=15%>&nbsp;</td>
            <td width=15%>Blood Component</td>
            <td>:</td>
            <td width=25% style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_component'].'</td>
        </tr>
    </table>
    ...
    <table width=90% cellpadding=0 cellspacing=0 align=center>
        <tr>
            ...
            <td>:</td>
            <td style="border-bottom: 1px solid black; font-weight: bold; padding: 3px;">&nbsp;'.$b['cmr_examination'].'</td>
            <td width=15%>&nbsp;</td>
            <td>&nbsp;</td>
            <td width=25%>&nbsp;</td>
        </tr>
    ...
    <table width=90% cellpadding=0 cellspacing=0 align=center>
        <tr>
            <td width=15%></td>
            <td style="font-style: italic; padding: 3px; font-weight: bold;">Compatibility Result:</td>
            <td style="font-style: italic; padding: 3px;">&nbsp;</td>
            <td width=15%>&nbsp;</td>
            <td>&nbsp;</td>
            <td width=25%>&nbsp;</td>
        </tr>
    ...
    <table width=50% cellpadding=0 cellspacing=0 align=center>
        <tr>
             <td align=center style="border-bottom: 1px solid black; font-weight: bold; padding: 3px; font-size: 16pt;">&nbsp;'.$b['cmr_compatibility'].'</td>
        </tr>
    </table>
