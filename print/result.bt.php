<?php
	...
	$order = $o->getArray("select *, date_format(extractdate,'%m/%d/%Y') as exdate, date_format(release_date,'%m/%d/%Y') as rdate from lab_samples where enccode = '$_REQUEST[enccode]' and `code` = 'LABOR1034' and serialno = '$_REQUEST[serialno]';");
...
<table width=100% cellpadding=2 cellspacing=0 style="font-size: 8pt; margin-top:20px;">
	...
	<tr>
        <td width=100% colspan=4 style="background-color: #b1a0c7; border-top: 1px solid black; padding: 5px; font-size:11pt;" align=center><b>'. $title. '&nbsp;</b></td>
	</tr>    
</table>
