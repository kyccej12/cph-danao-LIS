	...
	<script>
		...
		$(document).ready(function($) {
			...
			<?php if($status == 'Finalized' || $status == 'Cancelled') {
				...
				$("#srr_date").datepicker(); $("#ref_date").datepicker(); $("#itemExpiry").datepicker({changeMonth: true,changeYear: true});
				...
				<td width=60% valign=top>
					<table width=100% style="padding:0px 0px 0px 0px;">
						...
						<tr>
							...
							<td align=left>
								<input class="inputSearch2" style="width:70%;padding-left:22px;" type=text name="received_by" id="received_by" value="<?php echo $res['received_by']; ?>" onchange='javascript: saveSRRHeader();' >
								<input type="hidden" name="received_from" id="received_from" value="<?php echo $res['received_from']; ?>"  >
							</td>				
						</tr>
						<tr>
		...
		<table width="100%" cellspacing=2 cellpadding=0 >
			...
			<tr>
				...
				<td align=left>
					...
					<input type="hidden" name="itemCost" id="itemCost" value='0.00'>
					<input type="hidden" name="itemAmount" id="itemAmount" value='0.00'>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="bareThin" align=left width=40%>Expiray Date (If Applicable) :</td>
				<td align=left>
