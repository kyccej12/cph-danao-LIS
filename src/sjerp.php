<?php
	...
	switch($_POST['mod']) {
		...
		case "rejectSample":
			$con->dbquery("update IGNORE lab_samples set status = '2', stat_pinged = 'N', rejection_remarks = '".$con->escapeString(htmlentities($_POST['phleb_remarks']))."', updated_by = '$uid', updated_on = now() where record_id = '$_POST[lid]';");
		break;
		...
		case "resultSingle":
			...
			switch($_POST['submod']) {
				...
				break;
				case "havResult":
					$b = $con->getArray("select patient_stat, hav_result_igg, hav_result_igm, performed_by, remarks from lab_havresult where enccode = '$order[enccode]' and serialno = '$order[serialno]' and code = '$order[code]';");
					//echo "select patient_stat, result, performed_by, remarks from lab_enumresult where enccode = '$order[enccode]' and serialno = '$order[serialno]' and code = '$order[code]';";
				break;
				case "bloodType":
				...
				break;
				// case "ogtt":
				// 	$b = $con->getArray("select result, result2, result3, remarks from lab_ogtt where enccode = '$order[enccode]' and serialno = '$order[serialno]' and code = '$order[code]';");
				// break;
				case "typhoid":
		...
		case "saveOGTT":
			...
			if($cnt > 0) {
				$con->dbquery("UPDATE IGNORE lab_ogtt set result_date = '".$con->formatDate($_POST['ogtt_sodate'])."', result = '$_POST[ogtt_fbs]', result2 = '$_POST[ogtt_fhours]', result3 = '$_POST[ogtt_2hours]', fbs_urine = '$_POST[fbs_urine]', fhours_urine = '$_POST[fhours_urine]', shours_urine = '$_POST[shours_urine]', performed_by = '$_POST[ogtt_result_by]', remarks = '".$con->escapeString($_POST['ogtt_remarks']) . "' where enccode = '$_POST[ogtt_enccode]' and code = '$_POST[ogtt_code]' and serialno = '$_POST[ogtt_serialno]';");
			} else {
				$con->dbquery("INSERT IGNORE INTO lab_ogtt (enccode,result_date,sampletype,serialno,code,result,result2,result3,fbs_urine,fhours_urine,shours_urine,performed_by,remarks,created_by,created_on) VALUES ('$_POST[ogtt_enccode]','".$con->formatDate($_POST['ogtt_date'])."','$_POST[ogtt_spectype]','$_POST[ogtt_serialno]','$_POST[ogtt_code]','$_POST[ogtt_fbs]','$_POST[ogtt_fhours]','$_POST[ogtt_2hours]','$_POST[fbs_urine]','$_POST[fhours_urine]','$_POST[shours_urine]','$_POST[ogtt_result_by]','".$con->escapeString($_POST['ogtt_remarks'])."','$uid',now());");
			}
		...
		case "saveCrossMatching":
			...
			if($cnt > 0) {
				$con->dbquery("UPDATE IGNORE lab_crossmatching set result_date = '".$con->formatDate($_POST['cmr_date'])."', cmr_group = '$_POST[cmr_group]', cmr_group_pos = '$_POST[cmr_group_pos]', cmr_unitserial = '$_POST[cmr_unitserial]', cmr_segment = '$_POST[cmr_segment]', cmr_bloodtype = '$_POST[cmr_bloodtype]', cmr_bloodtype_group = '$_POST[cmr_bloodtype_group]', cmr_examination = '$_POST[cmr_examination]', cmr_datecollected = '".$con->formatDate($_POST['cmr_datecollected'])."', cmr_dateexpiry = '".$con->formatDate($_POST['cmr_dateexpiry'])."', cmr_component = '$_POST[cmr_component]', cmr_compatibility = '$_POST[cmr_compatibility]', remarks = '".$con->escapeString($_POST['cmr_remarks']) . "', updated_by = '$uid', updated_on = now() where enccode = '$_POST[cmr_enccode]' and `code` = '$_POST[cmr_ihomis_code]' and serialno = '$_POST[cmr_serialno]';");
			} else {
				$con->dbquery("INSERT IGNORE INTO lab_crossmatching (enccode,result_date,sampletype,serialno,code,cmr_group,cmr_group_pos,cmr_unitserial,cmr_segment,cmr_bloodtype,cmr_bloodtype_group,cmr_examination,cmr_datecollected,cmr_dateexpiry,cmr_component,cmr_compatibility,remarks,created_by,created_on) VALUES ('$_POST[cmr_enccode]','".$con->formatDate($_POST['cmr_date'])."','$_POST[cmr_sampletype]','$_POST[cmr_serialno]','$_POST[cmr_ihomis_code]','$_POST[cmr_group]','$_POST[cmr_group_pos]','$_POST[cmr_unitserial]','$_POST[cmr_segment]','$_POST[cmr_bloodtype]','$_POST[cmr_bloodtype_group]','$_POST[cmr_examination]','".$con->formatDate($_POST['cmr_datecollected'])."','".$con->formatDate($_POST['cmr_dateexpiry'])."','$_POST[cmr_component]','$_POST[cmr_compatibility]','".$con->escapeString($_POST['cmr_remarks'])."','$uid',now());");
			}
		...
		/* HAV Result */
		case "saveHavResult":
			list($cnt) = $con->getArray("select count(*) from lab_havresult where enccode = '$_POST[hav_enccode]' and code = '$_POST[hav_code]' and serialno = '$_POST[hav_serialno]';");
			if($cnt > 0) {
				$con->dbquery("UPDATE IGNORE lab_havresult set hav_result_igm = '$_POST[hav_result_igm]', hav_result_igg = '$_POST[hav_result_igg]',  result_date = '".$con->formatDate($_POST['hav_date'])."', remarks = '".$con->escapeString($_POST['hav_remarks']) . "' where enccode = '$_POST[hav_enccode] and code = '$_POST[hav_code]' and serialno = '$_POST[hav_serialno]';");
			} else {
				$con->dbquery("INSERT IGNORE INTO lab_havresult (enccode,result_date,sampletype,serialno,code,hav_result_igg,hav_result_igm,remarks,created_by,created_on) VALUES ('$_POST[hav_enccode]','".$con->formatDate($_POST['hav_date'])."','$_POST[hav_spectype]','$_POST[hav_serialno]','$_POST[hav_code]','$_POST[hav_result_igg]','$_POST[hav_result_igm]','".$con->escapeString($_POST['hav_remarks'])."','$uid',now());");
				//echo "INSERT INTO lab_enumresult (enccode,result_date,sampletype,serialno,code,result,remarks,created_by,created_on) VALUES ('$_POST[pt_enccode]','".$con->formatDate($_POST['pt_date'])."','$_POST[pt_spectype]','$_POST[pt_serialno]','$_POST[pt_code]','$_POST[pt_result]','".$con->escapeString($_POST['pt_remarks'])."','$uid',now());";
			}
			$con->updateLabSampleStatus($_POST['hav_enccode'],$_POST['hav_code'],$_POST['hav_serialno'],'3',$uid);
		break;

		case "validateHavResult":
			$con->dbquery("UPDATE IGNORE lab_havresult set hav_result_igm = '$_POST[hav_result_igm]', hav_result_igg = '$_POST[hav_result_igg]',  result_date = '".$con->formatDate($_POST['hav_date'])."', remarks = '".$con->escapeString($_POST['hav_remarks']) . "' where enccode = '$_POST[hav_enccode] and serialno = '$_POST[hav_serialno]';");
			
			
			$con->validateResult("lab_havresult",$_POST['hav_enccode'],$_POST['hav_code'],$_POST['hav_serialno'],$uid);
			$con->updateLabSampleStatus($_POST['hav_enccode'],$_POST['hav_code'],$_POST['hav_serialno'],'4',$uid);	
			//$con->dbquery("update so_details set result_available = 'Y' where so_no = '$_POST[pt_sono]' and branch = '$bid' and code = '$_POST[pt_code]' and sample_serialno = '$_POST[pt_serialno]';");
		...
		case "changeChemMachine":
			$con->dbquery("UPDATE IGNORE lab_samples set machine = '$_POST[machine]' where serialno = '$_POST[serialno]' and enccode = '$_POST[enccode]';");

			/* Check if result is available */
			list($isCount) = $con->getArray("select count(*) from lab_bloodchem where serialno = '$_POST[serialno]' and enccode = '$_POST[enccode]';");
			if($isCount > 0) {
				$con->dbquery("UPDATE IGNORE lab_bloodchem set machine = '$_POST[machine]' where serialno = '$_POST[serialno]' and enccode = '$_POST[enccode]';");
			}
		...
		case "changeCbcMachine":
			...
			/* Check if result is available */
			list($isCount) = $con->getArray("select count(*) from lab_cbcresult where serialno = '$_POST[serialno]' and enccode = '$_POST[enccode]';");
			if($isCount > 0) {
				$con->dbquery("UPDATE IGNORE lab_cbcresult set machine = '$_POST[machine]' where serialno = '$_POST[serialno]' and enccode = '$_POST[enccode]';");
			}
		...
		case "saveBloodChem":
			...
			if($cnt > 0) {
				$con->dbquery("UPDATE IGNORE lab_bloodchem SET result_date = '".$con->formatDate($_POST['bloodchem_date'])."',glucose='".$con->formatDigit($_POST['glucose'])."',uric = '".$con->formatDigit($_POST['uric'])."',bun = '".$con->formatDigit($_POST['bun'])."',creatinine = '".$con->formatDigit($_POST['creatinine'])."', ldh = '".$con->formatDigit($_POST['ldh'])."', cholesterol = '".$con->formatDigit($_POST['cholesterol'])."',triglycerides = '".$con->formatDigit($_POST['triglycerides'])."',hdl = '".$con->formatDigit($_POST['hdl'])."',ldl = '".$con->formatDigit($_POST['ldl'])."',vldl = '".$con->formatDigit($_POST['vldl'])."',sgot = '".$con->formatDigit($_POST['sgot'])."',sgpt = '".$con->formatDigit($_POST['sgpt'])."',alkaline = '".$con->formatDigit($_POST['alkaline'])."',bilirubin = '".$con->formatDigit($_POST['bilirubin'])."',bilirubin_direct = '".$con->formatDigit($_POST['bilirubin_direct'])."',bilirubin_indirect = '".$con->formatDigit($_POST['bilirubin_indirect'])."',protein = '".$con->formatDigit($_POST['protein'])."',albumin = '".$con->formatDigit($_POST['albumin'])."',globulin = '".$con->formatDigit($_POST['globulin'])."',agratio = '".$con->formatDigit($_POST['agratio'])."',electrolytes_na = '".$con->formatDigit($_POST['electrolytes_na'])."',electrolytes_k = '".$con->formatDigit($_POST['electrolytes_k'])."',electrolytes_ci = '".$con->formatDigit($_POST['electrolytes_ci'])."',total_calcium = '".$con->formatDigit($_POST['total_calcium'])."',phosphorus = '".$con->formatDigit($_POST['phosphorus'])."',ggt = '".$con->formatDigit($_POST['ggt'])."', ion_calcium = '".$con->formatDigit($_POST['ion_calcium'])."', troponin = '".$con->formatDigit($_POST['troponin'])."', amylase = '".$con->formatDigit($_POST['amylase'])."', lipase = '".$con->formatDigit($_POST['lipase'])."', hba1c = '".$con->formatDigit($_POST['hba1c'])."', procalcitonin = '".$con->formatDigit($_POST['procalcitonin'])."', cbg = '".$con->formatDigit($_POST['cbg'])."', rbs = '$_POST[rbs]', magnesium = '$_POST[magnesium]', inorganic_phos = '$_POST[inorganic_phos]',  remarks = '".$con->escapeString(htmlentities($_POST['remarks']))."',updated_by = '$uid',updated_on = NOW() where enccode = '$_POST[bloodchem_enccode]' and serialno = '$_POST[bloodchem_serialno]';");
			} else {
				$con->dbquery("INSERT IGNORE INTO lab_bloodchem (enccode,result_date,sampletype,serialno,glucose,uric,bun,creatinine,ldh,cholesterol,triglycerides,hdl,ldl,vldl,sgot,sgpt,alkaline,bilirubin,bilirubin_direct,bilirubin_indirect,protein,albumin,globulin,agratio,electrolytes_na,electrolytes_k,electrolytes_ci,total_calcium,ion_calcium,phosphorus,ggt,amylase,lipase,hba1c,procalcitonin,cbg,rbs,magnesium,inorganic_phos,prandial,remarks,created_by,created_on) VALUES ('$_POST[bloodchem_enccode]','".$con->formatDate($_POST['bloodchem_date'])."','$_POST[bloodchem_spectype]','$_POST[bloodchem_serialno]','".$con->formatDigit($_POST['glucose'])."','".$con->formatDigit($_POST['uric'])."','".$con->formatDigit($_POST['bun'])."','".$con->formatDigit($_POST['creatinine'])."','".$con->formatDigit($_POST['ldh'])."','".$con->formatDigit($_POST['cholesterol'])."','".$con->formatDigit($_POST['triglycerides'])."','".$con->formatDigit($_POST['hdl'])."','".$con->formatDigit($_POST['ldl'])."','".$con->formatDigit($_POST['vldl'])."','".$con->formatDigit($_POST['sgot'])."','".$con->formatDigit($_POST['sgpt'])."','".$con->formatDigit($_POST['alkaline'])."','".$con->formatDigit($_POST['bilirubin'])."','".$con->formatDigit($_POST['bilirubin_direct'])."','".$con->formatDigit($_POST['bilirubin_indirect'])."','".$con->formatDigit($_POST['protein'])."','".$con->formatDigit($_POST['albumin'])."','".$con->formatDigit($_POST['globulin'])."','".$con->formatDigit($_POST['agratio'])."','".$con->formatDigit($_POST['electrolytes_na'])."','".$con->formatDigit($_POST['electrolytes_k'])."','".$con->formatDigit($_POST['electrolytes_ci'])."','".$con->formatDigit($_POST['total_calcium'])."','".$con->formatDigit($_POST['ion_calcium'])."','".$con->formatDigit($_POST['phosphorus'])."','".$con->formatDigit($_POST['ggt'])."','".$con->formatDigit($_POST['amylase'])."','".$con->formatDigit($_POST['lipase'])."','".$con->formatDigit($_POST['hba1c'])."','".$con->formatDigit($_POST['procalcitonin'])."','".$con->formatDigit($_POST['cbg'])."','$_POST[rbs]','$_POST[magnesium]','$_POST[inorganic_phos]','$_POST[prandial]','".$con->escapeString(htmlentities($_POST['remarks']))."','$uid',NOW());");
		...
		case "saveAbgResult":
			...
			if($cnt > 0) {
				$con->dbquery("UPDATE IGNORE lab_abgresult set result_date = '".$con->formatDate($_POST['abg_date'])."', ph = '$_POST[abg_ph]', pco2 = '$_POST[abg_pco2]', po2 = '$_POST[abg_po2]', thb = '$_POST[abg_thb]', so2 = '$_POST[abg_so2]', be = '$_POST[abg_be]', hco3 = '$_POST[abg_hco3]', hctc = '$_POST[abg_hctc]', temp = '$_POST[abg_temp]', tc02 = '$_POST[abg_tco2]', fi02 = '$_POST[abg_fio2]',  remarks = '".$con->escapeString($_POST['abg_remarks']) . "', updated_by = '$uid', updated_on = now() where enccode = '$_POST[abg_enccode]' and code = '$_POST[abg_ihomis_code]' and serialno = '$_POST[abg_serialno]';");
			} else {
				$con->dbquery("INSERT IGNORE INTO lab_abgresult (enccode,result_date,sampletype,serialno,code,ph,pco2,po2,thb,so2,be,hco3,hctc,temp,tc02,fi02,remarks,created_by,created_on) VALUES ('$_POST[abg_enccode]','".$con->formatDate($_POST['abg_date'])."','$_POST[abg_spectype]','$_POST[abg_serialno]','$_POST[abg_ihomis_code]','$_POST[abg_ph]','$_POST[abg_pco2]','$_POST[abg_po2]','$_POST[abg_thb]','$_POST[abg_so2]','$_POST[abg_be]','$_POST[abg_hco3]','$_POST[abg_hctc]','$_POST[abg_temp]','$_POST[abg_tco2]','$_POST[abg_fio2]','".$con->escapeString($_POST['abg_remarks'])."','$uid',now());");
			}
		...
		case "printresult":
			$con->dbquery("update lab_samples set printed_on = now() where enccode = '$_POST[enccode]' and serialno = '$_POST[serialno]';");
		break;

		case "resultRestore":
			$con->dbquery("update lab_samples set status = '1' where enccode = '$_POST[enccode]' and record_id = '$_POST[lid]';");
		break;
